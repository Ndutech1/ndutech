        ...
        >
          ...
          <div className="space-y-4 rounded-[32px] border border-white/10 bg-slate-900/80 p-6 shadow-glass">
            ...
            <ul className="space-y-3 text-slate-300">
              <li>• Clean, maintainable React code with modern animation and responsive design.</li>
              <li>• Real-world drone/GIS experience plus software engineering expertise.</li>
              <li>• Fast delivery of polished interfaces, dashboards, and mobile workflows.</li>
            </ul>
          </div>
        </motion.div>
      </div>
